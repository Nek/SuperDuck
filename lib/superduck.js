...
function recParsePath(nestedParse, p) {
    return _if(is.Array, 
               _p(identity, []), 
                _c(
                    _if(
...
function nestedParse(p,e) {
    return _if(eqWildcard, 
               _p(array, e),
               _c(
                   _if( 
                       sizeEqZero,
                   ...
                   _p(recParsePath, nestedParse)
               ))(p[e]);}


var parsePath = _c(_p(map, _if(_c(is.Array, _.first), _.first, identity)), _p(recParsePath,nestedParse));
