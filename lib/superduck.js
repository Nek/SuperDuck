...
var enrich = function(f, d) {
    return [d,f(d)];
};

var concatEach = function(a) {
            return _c(
                _p( map, _p(concat, _c(array,_.first,_.first)(a))),
                _.first,
                _.last
            )(a);
        };
...
function nestedParse(kv) {
    return _if(_c(eqWildcard, _.last),
                  _c(array, _.first),
                  _c(
                      _if(
                          _c(sizeEqZero,_.last),
                          emptyArray,
                          concatEach
                      ),
                      _p(enrich, _c(recParsePath,_.last))
                  ))(kv);}
