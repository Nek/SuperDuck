...
var emptyArray = _p(identity, []);

var keys = _if(is.Object, Object.keys, emptyArray);

function keysValues(a) {
    return keys(a).map(function(k){return [k, a[k]];});
};
...
var sizeEqZero = _c(_p(eq, 0), size);
...
function concatEach(a) {
            return _c(
                _p( map, _p(concat, _c(array,first,first)(a))),
                first,
                last
            )(a);
        };
...
var recParsePath;
function nestedParse(kv) {
    return _if(_c(eqWildcard, last),
                  _c(array, first),
                  _c(
                      _if(
                          _c(sizeEqZero,last),
                      ...
                      _p(enrich, _c(recParsePath,last))
                  ))(kv);}
...
var parsePath = _c(_p(map, _if(_c(is.Array, first), first, identity)), recParsePath);
