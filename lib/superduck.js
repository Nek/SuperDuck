        ...
        return cond(is.Array(p), 
                    ...
                    _c(
                        _if(
                            ...
                            _p(identity, []), 
                            _c( 
                                _p(filter,function(e) {return e.length > 0;}), 
                                _p(map, _p(nestedParse, p)))
                        ), 
                        keys
                    )(p)); 
    };

    return _c(_p(map, _if(_c(is.Array, _.first), _.first, identity)), recParsePath)(p);
};
